    ...
    <footer className="text-gray-600 body-font">
      <div className="container mx-auto flex justify-between p-5 items-center">
        ...
        <div className="flex gap-2 md:gap-10">
          <div className="text-xs md:text-xl font-bold">Shop</div>
          <div className="text-xs md:text-xl font-bold">About</div>
          <div className="text-xs md:text-xl font-bold">Blog</div>
          <div className="text-xs md:text-xl font-bold">Pricing</div>
        </div>
      </div>
      <div>
